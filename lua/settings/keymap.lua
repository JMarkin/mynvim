...
function maps(m)
    ...
    nnoremap({ "<space><right>", "<C-l>" }, function()
        require("smart-splits").move_cursor_right()
    end, "silent", "right")
    nnoremap({ "<space><down>", "<C-j>" }, function()
        require("smart-splits").move_cursor_down()
    end, "silent", "down")
    nnoremap({ "<space><up>", "<C-k>" }, function()
        require("smart-splits").move_cursor_up()
    end, "silent", "top")
    nnoremap({ "<space><left>", "<C-l>" }, function()
        require("smart-splits").move_cursor_left()
    end, "silent", "left")

    -- resizing splits
    nnoremap({ "<A-left>", "<A-h>" }, function()
        require("smart-splits").resize_left()
    end, "silent", "Resize left")
    nnoremap({ "<A-down>", "<A-j>" }, function()
        require("smart-splits").resize_down()
    end, "silent", "Resize down")
    nnoremap({ "<A-up>", "<A-k>" }, function()
        require("smart-splits").resize_up()
    end, "silent", "Resize up")
    nnoremap({ "<A-right>", "<A-l>" }, function()
